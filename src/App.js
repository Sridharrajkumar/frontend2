...
function App() {
  ...
  const expenses=[
    {title:'car insurance', amount:500.50 ,date: new Date(2023, 7, 6) , LocationOfExpenditure:'car showroom'},
    {title:'bike insurance', amount:255.60 ,date: new Date(2023, 7, 6) , LocationOfExpenditure:'bike showroom'},
    {title:'house insurance', amount:1050.70 ,date: new Date(2023, 7, 6) , LocationOfExpenditure:'house emi'},
    {title:'hotel', amount:50.50 ,date: new Date(2023, 7, 6) , LocationOfExpenditure:'hotel restaurant'},
